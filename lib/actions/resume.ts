...
import Education from "../mongoose/models/education.model";
import Experience from "../mongoose/models/experience.model";
import Resume from "../mongoose/models/resume.model";
import Skill from "../mongoose/models/skill.model";
